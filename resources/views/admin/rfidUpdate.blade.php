...
<div class="row">
    <div class="col text-center">
        <h3>{{$user->name}}</h3>
        <form action="/admin/rfid/update" method="post">
            @csrf
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card mx-auto text-center my-2">
                        <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="m-2 text-warning mx-auto bi bi-person-badge w-75" viewBox="0 0 16 16">
